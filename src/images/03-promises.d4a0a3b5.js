...
})(
  {
    ...
    GyVV: [
      function (require, module, exports) {
        ...
        function o(e) {
          e.preventDefault(),
            i(Number(t.inputDelay.value), Number(t.inputStep.value), Number(t.inputAmount.value));
        }
        function i(t, o, i) {
          for (let u = 1, r = t; u <= i; u += 1, r += o)
            setTimeout(
              () =>
                n(u, r)
                  .then(({ position: t, delay: o }) => {
                    e.Notify.success(`✅ Fulfilled promise ${t} in ${o}ms`);
                  })
                  .catch(({ position: t, delay: o }) => {
                    e.Notify.failure(`❌ Rejected promise ${t} in ${o}ms`);
                  }),
              r,
            );
        }
        function n(e, t) {
          return Math.random() > 0.3
            ? Promise.resolve({ position: e, delay: t })
            : Promise.reject({ position: e, delay: t });
        }
        t.form.addEventListener('submit', o);
      },
...
//# sourceMappingURL=/goit-js-hw-09/03-promises.d4a0a3b5.js.map
